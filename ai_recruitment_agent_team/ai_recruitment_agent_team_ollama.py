...
def init_session_state() -> None:
    ...
    defaults = {
        'candidate_email': "", 'resume_text': "", 'analysis_complete': False,
...
def schedule_interview(scheduler: Agent, candidate_email: str, email_agent: Agent, role: str) -> None:
    ...
    try:
        ...
        print(f"DEBUG: Meeting response: {meeting_response}")  # Debug
        email_agent.run(
...
def main() -> None:
    ...
    with st.sidebar:
        ...
        required_configs = {'Zoom Account ID': st.session_state.zoom_account_id,
